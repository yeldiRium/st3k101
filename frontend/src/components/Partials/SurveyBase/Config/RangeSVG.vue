...
export default {
  ...
  methods: {
    ...
    startHover(number) {
      ...
      forEach(elem => elem.classList.add("range-svg--hover"), lines);
      forEach(elem => elem.classList.add("range-svg--hover"), texts);
    },
    endHover(number) {
      const lines = this.$el.getElementsByClassName(
        `range-svg__number-line-${number}`
      ...
      forEach(elem => elem.classList.remove("range-svg--hover"), lines);
      forEach(elem => elem.classList.remove("range-svg--hover"), texts);
    },
    /**
