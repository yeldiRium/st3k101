...
function fetchQuestionStatisticsByQuestionnaire(
  authenticationToken,
  href = null
) {
  ...
  return fetchApi(apiEndpoint, {
    ...
    .chain(statistics => {
      ...
      for (let statistic of statistics) {
        parsedStatistics = parsedStatistics.concat(
          parseQuestionStatistic(statistic)
        );
      }
...
export { fetchQuestionStatistic, fetchQuestionStatisticsByQuestionnaire };
